                  ...
                  builder: (_, readOnly, __) => TextField(
                    controller: TextEditingController(
                      ...
                      ..selection = TextSelection.collapsed(
                          offset: newNoteController.content.length),
                    focusNode: focusNode,
                    readOnly: readOnly,
                    onChanged: (value) {
                      newNoteController.content = Document()..insert(0, value);
                    },
                    maxLines: null, // wieloliniowe
                    expands: true, // wypełnia dostępną przestrzeń
                    decoration: const InputDecoration(
                      hintText: 'Note here...',
                      border: InputBorder.none,
                    ),
